...
`build → understand → secure → evolve`
...
```text
IDENTITY     Software Engineering · Cybersecurity · AI Systems
DIRECTION    Security Engineering → Security Architecture
FOUNDATION   Linux · Networking · Systems · Secure Development
BUILDING     Products · Security tooling · AI agents · Infrastructure
STATUS       Learning deeply. Building constantly. Shipping deliberately.
```
...
### `02 // Frontend & Interfaces`

<img src="https://skillicons.dev/icons?i=ts,js,react,nextjs,vue,html,css,tailwind&theme=dark" alt="Frontend stack" />

<br />

`Web applications` · `Dashboards` · `Product interfaces`
...
`Web security` · `OSINT` · `Detection` · `LLMs` · `Agents`
...
<sub>Software Engineering · Cybersecurity · AI Systems · Linux Infrastructure</sub>
